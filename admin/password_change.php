                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="POST" name="proform" action="password_db.php">
                                   
  									<div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>User Id</label>
                                                <input type="text" class="form-control"  name="UserId"  required value="<?php echo $id ?>">
                                            </div>
                                        </div>
									</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  name="fname" placeholder="First Name" required value="<?php echo $fname ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control"  name="email" placeholder="Email"  value="<?php echo $mail ?>">
                                            </div>
                                        </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right" name="update" onclick="validateform1()">Update Password</button>

...
<?php		
			...
			$result=$dbh->prepare("Select * From userdata limit $page1,5");
			$result->execute();
  ...
  <?php   
	...
	?>
                                        <tr>
											...
											<td></td>
										<?php	
								                echo "<td><a href='update_status.php?userid=$Id'>De-Activated</a></td>";
								?>
                                        </tr>
					<?php
	}
...
$a=$count/4;
			for($b=1;$b<=$a;$b++){
										?><a href="table.php?page=<?php echo $b?>"style="text-decoration:none"><?php echo $b." ";?></a> <?php
			}
											 ?>
                            </div>
